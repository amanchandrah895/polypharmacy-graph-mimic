...
\author{
\IEEEauthorblockN{Aman Chandra H, Kriti Ravi Pandit, and Vidya M J}
\IEEEauthorblockA{School of Computer Science and Engineering \\
RV University, Bengaluru, India \\
amanch.btech23@rvu.edu.in}
}
...
independent confidence intervals. Table~\ref{tab:significance} reports a
statistically significant advantage for the embedding ($\Delta$=+0.0178,
95\% CI [0.0112, 0.0249], $p<0.0001$).
...
To test whether this is specific to the subsample drawn, we repeated the
entire pipeline -- cohort draw, graph construction, node2vec training, and
significance test -- on a second, independent subsample with \emph{zero
overlap} with the original (seed=123, $n=9{,}976$). The effect replicated
(Table~\ref{tab:replication}): $\Delta$=+0.0152, 95\% CI [0.0081, 0.0218],
overlapping the original CI.
